...
function loadCoutLive() {
    ...
    text.innerHTML = 'Bạn đã sống ' + (today.getFullYear() - my_birthday.getFullYear()) + " năm<br>" +
        "Bạn đã sống " + count_months(my_birthday) + " tháng<br>" +
        "Bạn đã sống " + count_day(my_birthday) + " ngày<br>" +
        "Bạn đã sống " + count_hours(my_birthday) + " giờ<br>" +
        "Bạn đã sống " + count_minutes(my_birthday) + " phút<br>" +
        "Bạn đã sống " + count_seconds(my_birthday) + " giây<br>"
